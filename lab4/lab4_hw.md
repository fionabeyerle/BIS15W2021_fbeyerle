...
```
## [1] "D:/TA files/Winter2021 BIS15L/students_rep/BIS15W2021_fbeyerle/lab4"
```
...
```r
herbivore_mean <- herbivore$mean.hra.m2
mean(herbivore_mean, na.rm=T)
```
...
```r
carnivore_mean <- carnivore$mean.hra.m2
mean(carnivore_mean, na.rm=T)
```
