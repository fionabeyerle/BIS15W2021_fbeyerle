...
homerange %>% 
  ...
  geom_histogram(alpha = 0.9, color = "black", fill = "lavender", bins=40)+
...
```r
homerange <-homerange %>%
  mutate(range_category=case_when(log10.hra<3.65 ~ "very small", log10.hra>=3.65 & log10.hra <4.59 ~ "small",
...
## $ prey.size.reference        <chr> NA, NA, NA, NA, NA, NA, "Brose U, et al. 2…
## $ mass_category              <chr> "large", "medium", "small", "small", "smal…
## $ range_category             <chr> "small", "very small", "very small", "very…
```
